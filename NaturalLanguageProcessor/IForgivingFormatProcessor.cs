namespace NaturalLanguageProcessor
{
    ...
    public record TaskInformation(string Description, DateOnly? Date, TimeOnly? Time);
    ...
    public interface IForgivingFormatProcessor
    {
        ...
        /// <returns></returns>
        DateOnly ProcessNaturalDate(string input);
        /// <summary>
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        TimeOnly ProcessNaturalTime(string input);
        /// <summary>
