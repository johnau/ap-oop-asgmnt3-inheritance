...
public record RecognizerNumberResult(double Value, string Text, int Start, int End) { }
public record RecognizerNumberRangeResult(double Value1, double Value2, string Text, int Start, int End) { }
public record RecognizerAgeResult(double Value, string Period, string Text, int Start, int End) { }
...
internal class RecognizersWrapper
{
    ...
    public List<RecognizerNumberResult> ParseWithNumberRecognizer(string query)
    {
    ...
    public List<RecognizerNumberResult> ParseWithOrdinalRecognizer(string query)
    {
    ...
    public List<RecognizerAgeResult> ParseWithAgeRecognizer(string query)
    {
